...
class Document:
    ...
    def serialize_for_results(self) -> dict[str, Any]:
        """
        Serializes the document object for displaying search results.
        """
        return {
            "id": self.id,
...
class Approach(ABC):
    """
    Abstract base class for different approaches in the application.
    """
    ...
    def get_citation(self, sourcepage: str, use_image_citation: bool) -> str:
        """
        Generates a citation for a source page.
        """
